...
export default function ReferenceField({ field, value, onSelect, owner, repo, branch, locale, disabled, onChange, ...rest }) {
    ...
    return (<div className="md:flex md:items-center w-full">
        <div className="md:flex md:items-center w-full">
            ...
            {!loaded &&
                <div role="status" className="absolute ml-4">
                    <svg aria-hidden="true" className="w-6 h-6 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
