                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="mt-2">
                                            <div className="text-sm text-gray-500 flex items-center space-x-1">
                                                ...
                                                <input className={"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" + (hasError && !name ? ' border-red-500' : '')} type="text" placeholder={`${title}`} onChange={e => setName(e.target.value.toLowerCase())} />
