        ...
        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            ...
            <div>
                <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <Link to={pathname} className={"relative z-10 inline-flex items-center border px-4 py-2 text-sm font-medium focus:z-20 " + (page == 1 ? activeClass : inactiveClass)}>1</Link>
                    ...
                    {lastPage > 2 && <Link to={`${pathname}?page=${lastPage}`} className={"relative z-10 inline-flex items-center border px-4 py-2 text-sm font-medium focus:z-20 " + (page == lastPage ? activeClass : inactiveClass)}>{lastPage}</Link>}
