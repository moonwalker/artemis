export default () => (<div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
        <a class="group relative flex w-full justify-center rounded-md border py-2 px-4 text-sm text-zinc-700 font-medium shadow-sm shadow-zinc-300 hover:bg-zinc-600 hover:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2" href={import.meta.env.VITE_MOONBASE_API_URL + "/logout"}>
