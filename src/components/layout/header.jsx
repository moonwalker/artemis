  ...
  return (
    <header className="p-4 bg-zinc-100 shadow-inner fixed inset-x-0 top-0 md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
      <a href="/" className="flex items-center">
        <img src={logo} className="h-6 mr-3 sm:h-9" alt="Artemis" />
        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Artemis</span>
      </a>
      {!!user && <div className="flex items-center md:order-2">
        <div type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
